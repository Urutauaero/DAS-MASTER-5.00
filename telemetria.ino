...
void telemetria_setup(){
  ...
  Serial.println(F("DAS 19 Urutau Aerodesign"));
...
void serial_write(){
    ...
    unsigned long tempo_serial = tempo * 10;
...
//  uint8_t h = t.hour, m = t.min;

   Serial.print(t.date, DEC); Serial.print(F("/")); Serial.print(t.mon); Serial.print(F("/")); Serial.print(t.year, DEC);
  Serial.print("  ");
...
void print_logo(){
  /**
  String logo1 = F("  _   _          _                    _ _ _ ");
  String logo2 = F(" | | | |_ __ _  | |_ __ _   _   _    / \\ ___ _ __ ___ __| | ___ ___(_) __ _ _ __ ");
  String logo3 = F(" | | | | '__| | | | __/ _` | | | |  / _ \\ / _ \\ '__/ _ \\ / _` |/ _ \\/ __| |/ _` | '_ \\ ");
  String logo4 = F(" | |_| | |  | |_| | || (_| | |_| | / ___ \\ __/ | | (_) | (_| | __/\\__ \\ | (_| | | | |");
  String logo5 = F(" \\___/|_|  \\__,_|  \\__\ \__,_|\\__,_| /_/ \\_\\___|_| \\___/ \\__,_|\\___||___/_|\\__, |_| |_|");
  String logo6 = F(" |___/ ");
  */
